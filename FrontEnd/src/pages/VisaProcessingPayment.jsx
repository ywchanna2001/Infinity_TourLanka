...
import VisaProcessingProgressBar from '../components/VisaProcessingProgressBar';
  ...
  return (
    ...
    <form style={{
                ...
                <div className="col-span-2">
                    <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div className="sm:col-span-4">
                            <label htmlFor="card_number" className="block text-sm font-medium leading-6 text-left">
                                Card Number
                            </label>
                            <div className="mt-2">
                                <input
                        ...
                        <div className="sm:col-span-3">
                            <label htmlFor="first-name" className="block text-sm font-medium leading-6 text-left">
                                Expiry Date
                            </label>
                            <div className="mt-2">
                                <input
                        ...
                        <div className="sm:col-span-3">
                            <label htmlFor="last-name" className="block text-sm font-medium leading-6 text-left">
                                CVV
                            </label>
                            <div className="mt-2">
                                <input
        ...
        <div className="mt-6 flex items-center justify-end gap-x-6">
            <CustomButton text="Clear All" backgroundColor="#0F6466" width="10rem" />
            <CustomButton text="Make Payment" backgroundColor="#0F6466" width="10rem" />
        </div>
    </form>
    </VisaProcessingBackground>
  );
